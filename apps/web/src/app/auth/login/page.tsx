    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-[#020617] text-slate-200 flex items-center justify-center p-6">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-2 font-medium">Log in to your CodePad account</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="text-[10px] font-bold uppercase tracking-widest text-primary hover:text-blue-400 transition-colors">Forgot?</a>
              </div>
              <div className="relative">
        ...
        <p className="text-center mt-8 text-sm text-slate-500 font-medium">
          ...
          <Link href="/auth/register" className="text-primary hover:text-blue-400 font-bold transition-colors underline underline-offset-4">
            Create an account
          </Link>
        </p>
      </motion.div>
